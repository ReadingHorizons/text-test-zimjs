...
declare function rarity(weights:{any}, shuffle?:boolean, zimColors?:boolean, dynamicPayload?:boolean):[any]
...
declare class Vid extends Container {
    constructor(config_or_file?:string, width?:number, height?:number, volume?:number, loop?:boolean, type?:string, style?:boolean, group?:string, inherit?:{})
    constructor(config:{file?:string, width?:number, height?:number, volume?:number, loop?:boolean, type?:string, style?:boolean, group?:string, inherit?:{}})
    play():this
    pause(state?:boolean):this
    keyOut(color?:color, tolerance?:number):this
...
export function rarity(weights:{any}, shuffle?:boolean, zimColors?:boolean, dynamicPayload?:boolean):[any]
